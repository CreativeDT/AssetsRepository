...
const CategoryItem = ({
  ...
  return (
    // <div
    //   className="bg-white p-6 rounded-lg shadow-sm transition-transform duration-200 hover:scale-105 hover:shadow-md h-full flex flex-col relative group overflow-hidden"
    ...
    //       <span className="text-gray-900 font-black text-4xl tracking-wide">
    //         Upcoming Asset
    //       </span>
    //     </div>
    //   )}
