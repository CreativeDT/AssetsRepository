...
import { faEnvelope, faMapMarkerAlt, faTimes } from '@fortawesome/free-solid-svg-icons';
...
<div
   ...
   {/* <h2 className="text-2xl font-bold text-gray-800 mb-6">Contact Us</h2>  */}
    <div className="bg-white rounded-lg shadow-xl overflow-hidden max-w-4xl w-full mx-auto my-8 p-8"> {/* Add some margin and padding for a standalone page look */}
  
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Left Side - Contact Information */}
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Lets Get In Touch</h2>
          <div className="flex items-center mb-4">
            <FontAwesomeIcon icon={faEnvelope} className="text-teal-500 mr-3" size="lg" />
            <p className="text-gray-700">info@global-csg.com</p>
          </div>
          <div className="flex items-start mb-4">
            <FontAwesomeIcon icon={faMapMarkerAlt} className="text-teal-500 mr-3" size="lg" />
        ...
        <div>
          ...
          <form className="space-y-4">
            ...
            <div>
              <label htmlFor="hearAboutUs" className="block text-gray-700 text-sm font-bold mb-2">How did you hear about us?*</label>
              <textarea id="hearAboutUs" rows="2" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
            <div>
              <label htmlFor="tellUsMore" className="block text-gray-700 text-sm font-bold mb-2">Tell us more!</label>
              <textarea id="tellUsMore" rows="3" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
